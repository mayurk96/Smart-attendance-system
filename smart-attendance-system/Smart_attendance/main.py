...
window.configure(background='#FFE99A')

frame1 = tk.Frame(window, bg="#FFD586")
frame1.place(relx=0.11, rely=0.17, relwidth=0.39, relheight=0.80)

frame2 = tk.Frame(window, bg="#FFD586")
...
frame4 = tk.Frame(window, bg="#262523")
...
if exists:
    ...
    res = 0
message.configure(text='Total Registrations till now  : ' + str(
    res))  ### make the changes in frontend dont change the code login just change the color and design
